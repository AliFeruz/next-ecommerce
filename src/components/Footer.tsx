...
const Footer = () => {
  return (
    <div className='px-4 py-24 md:px-8 lg:px-16 xl:px-32 2xl:px-64 mt-24 bg-blue-100/30 text-sm'>
      <div className='flex flex-col md:flex-row justify-between gap-24'>
        <div className='w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8'>
        <Link href={"/"} className="text-2xl tracking-wide">
          LAMA
        </Link>
        <p>The address is 2025 M Street, NW, Washington, DC, 20036. 2.</p>
        <span>test@gmail.com</span>
        <span>+49 921 000 6598</span>
        ...
        <div className='w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8'>
          <h1 className='uppercase font-medium text-xl'>Subscribe</h1>
